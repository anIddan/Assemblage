...
h.style.top=r+"px",h.style.left=(h.width+e)*h.index+e+"px",h.style.position="absolute",this.render||n.appendChild(h),this.images[o]=h,this.index[h.row][h.index]=h}.bind(this)),this.render++}.bind(this),window.addEventListener("resize",this.size)}